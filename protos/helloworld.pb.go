...
func (x *ResponseStreamRequest) Reset() {
	*x = ResponseStreamRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ResponseStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResponseStreamRequest) ProtoMessage() {}

func (x *ResponseStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResponseStreamRequest.ProtoReflect.Descriptor instead.
func (*ResponseStreamRequest) Descriptor() ([]byte, []int) {
	return file_helloworld_proto_rawDescGZIP(), []int{2}
}

func (x *ResponseStreamRequest) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
type ResponseStreamReply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ResponseStreamReply) Reset() {
	*x = ResponseStreamReply{}
	if protoimpl.UnsafeEnabled {
...
func (x *ResponseStreamReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResponseStreamReply) ProtoMessage() {}

func (x *ResponseStreamReply) ProtoReflect() protoreflect.Message {
	mi := &file_helloworld_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResponseStreamReply.ProtoReflect.Descriptor instead.
func (*ResponseStreamReply) Descriptor() ([]byte, []int) {
	return file_helloworld_proto_rawDescGZIP(), []int{3}
}

func (x *ResponseStreamReply) GetMessage() int32 {
	if x != nil {
		return x.Message
	}
	return 0
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x2f, 0x0a, 0x15, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x2f, 0x0a, 0x13, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0xf3, 0x01, 0x0a,
	...
	0x6c, 0x79, 0x22, 0x00, 0x12, 0x5c, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x12, 0x21, 0x2e, 0x68, 0x65, 0x6c,
	...
	0x6e, 0x73, 0x65, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00,
	0x30, 0x01, 0x42, 0x13, 0x5a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x68, 0x65, 0x6c,
...
var file_helloworld_proto_goTypes = []interface{}{
	...
	(*ResponseStreamRequest)(nil), // 2: helloworld.ResponseStreamRequest
	(*ResponseStreamReply)(nil),   // 3: helloworld.ResponseStreamReply
}
var file_helloworld_proto_depIdxs = []int32{
	...
	2, // 2: helloworld.GreeterService.ResponseStreamData:input_type -> helloworld.ResponseStreamRequest
	...
	3, // 5: helloworld.GreeterService.ResponseStreamData:output_type -> helloworld.ResponseStreamReply
...
func file_helloworld_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_helloworld_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResponseStreamRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_helloworld_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResponseStreamReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
